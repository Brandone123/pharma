...
<div class="row">
                    <div class="col-md-12">
                        <div class="card card-body printableArea">
                            <h3><b>FACTURE</b> <span class="pull-right">#<?php echo $invoice->invoice_no; ?></span></h3>
                            <hr>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">
                                    ...
                                    <div class="pull-right text-right">
                                        <address>
                                            ...
                                            <p class="m-t-30"><b>Date de Facturation :</b> <i class="fa fa-calendar"></i> <?php echo date('l jS \of F Y',$invoice->create_date); ?></p>
                                        </address>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="table-responsive m-t-40" style="clear: both;">
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="text-center">Identifiant du produit</th>
