                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-header">
                                ...
                                <h4 class="m-b-0 text-white">Client En Gros </h4>
                                        ...
                                        <tbody>
                                           <?php foreach($wholesaleList as $value): ?> 
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $value->c_note; ?></td>
                                                <td>
                                                    <?php if (empty($value->c_img)) {?>
                                                    <img src="<?php echo base_url();?>assets/images/custom.png" alt="" height="25" class="img-rounded image_rounded">
                                                    <?php }else{?>
                                               ...
                                               <?php if($this->session->userdata('user_type') =='ADMIN' || $this->session->userdata('user_type') =='MANAGER'){ ?>
                                                <td class="jsgrid-align-center ">
                                                    ...
                                                    <a onclick="return confirm('Etês-vous sûre de vouloir Supprimer?')" href="<?php echo base_url();?>customer/delete?id=<?php echo $value->c_id;?>" title="Delete" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
          ...
          <div class="modal-dialog modal-lg"   style="max-width:60%!important"  role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Mise à Jour Client</h5>
              ...
              <form action="Update" method="post"  id="customerform"  class="form-horizontal"  enctype="multipart/form-data" accept-charset="utf-8">
                    <div class="modal-body">
                        <div class="row">
                                        ...
                                        <input type="text" class="form-control" name="cname" placeholder="Customer name" required minlength="1">
                                            ...
                                            <div class="col-md-6" id="storeneme">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label text-right">Nom de la pharmacie</label>
                                                    <div class="">
                                                        <input type="text" class="form-control" name="pname" placeholder="Phrmacy Name" minlength="1">
                                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label text-right">Numéro</label>
                                    <div class="">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label text-right">Adresse</label>
                                    <div class="">
        ...
        $(document).ready(function () {
            ...
            $(".customerid").click(function (e) {
                ...
                $.ajax({
                    ...
                    $('#customerform').find('[name="pname"]').val(response.mvalue.pharmacy_name).end();
