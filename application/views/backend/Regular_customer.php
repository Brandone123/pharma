                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Client Régulier</h4>
                            </div>
          ...
          <div class="modal-dialog modal-lg"   style="max-width:60%!important"  role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Mise à Jour Du Client</h5>
                                        ...
                                        <input type="text" class="form-control" name="cname" placeholder="Customer name" required minlength="1">
                                            ...
                                            <div class="col-md-6" id="storeneme">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="">
                                                        <input type="text" class="form-control" name="pname" placeholder="Phrmacy Name" required minlength="1">
                                                    </div>
