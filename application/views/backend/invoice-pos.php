                     ...
                     <form action="" method="post"  class="SalesForm" id="SalesForm" enctype="multipart/form-data">
                      <div class="row m-b-5">
                        <div class="col-md-3">
                          ...
                          <label for="WalkIn_customer">Client de passage</label>
                        </div>                       
                        <div class="col-md-2">
                          <input name="customer_type" value="Regular" type="radio" id="regular_customer"  tabindex="-1">
                          <label for="regular_customer">Client Régulier</label>
                        </div>
                        <div class="col-md-2">
                          <input name="customer_type" value="Wholesale" type="radio" id="wholesale_customer" tabindex="-1">
                          <label for="wholesale_customer">Client En Gros</label>
                        </div>

                        <div class="col-md-0" >
                           <a href="<?php echo base_url('invoice/Pos_Create');?>" class="btn btn-sm btn-info waves-effect waves-light text-white" tabindex="-1">Nvlle Facture</a>
                        </div>

                        <div class="col-md-0">
                            <a href="<?php echo base_url();?>Invoice/manage_Invoice" target="_blank" class="btn btn-sm btn-info waves-effect waves-light" tabindex="-1">Gérer Les Factures</a>
                        </div>
                      </div>
                      <div class="row m-b-5">
                        <div class="col-md-3 p-r-5">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="cusid" id="cusid" placeholder="Rechercher un Client" tabindex="1" autocomplete="off" >
                          ...
                          <div class="row">
                            <div class="col-md-6">
                                <span class="custom-text-button">
                                  Date:<?php date_default_timezone_set("Africa/Douala"); echo date("j M y") ?>
                            ...
                            <div class="col-md-6">
                            <span class="custom-text-button">
                                  Time:<?php date_default_timezone_set("Africa/Douala"); echo date("h:i A") ?>                                  
                                </span>
                            </div>
                          </div>
                      </div>
                            ...
                            <div class="col-md-4" style="">
                              <div class="input-group">
                               ...
                               <!--  <select class="js-product-data-ajax form-control product" name="proval" style="width:100%" required id="product_name" tabindex="2" autocomplete="off">
                                ...
                                <input type="text" class="form-control proval" name="proval" placeholder="Rechercher un produit"  id="product_name" tabindex="2" autocomplete="off"> 
                              </div>
                              </div>
                            <div class="col-md-3">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control mrp" name="mrp" id="mrp" placeholder="HT" readonly tabindex="-1" value="">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="input-group">
                      ...
                      <form action="Save" method="post" name="SalesFormConfirm" class="SalesFormConfirm" id="SalesFormConfirm" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          <div class="row form-group">
                            <div class="col-md-5">
                              <label for="example-text-input" class=" col-form-label pos-label">TVA
                              </label>
                            </div>
                            <div class="col-md-7">
                              <input class="form-control " name="" type="text" value="0 FCFA" style="" tabindex="-1" readonly>
                            </div>
                          </div>
                          <div class="row form-group">
                            <div class="col-md-5">
                              <label for="example-text-input" class=" col-form-label pos-label">Total TTC
                              </label>
                            </div>
                            <div class="col-md-7">
                          ...
                          <div class="row form-group">
                            <div class="col-md-5">
                              <label for="example-text-input" class=" col-form-label pos-label">Payé Comptant
                              </label>
                            </div>
                            <div class="col-md-7">
                              <input class="form-control pay payable" type="text" name="pay" value="" style="" tabindex="-1">
                            </div>
                          </div>
                          <div class="row form-group">
                            <div class="col-md-5">
                              <label for="example-text-input" class=" col-form-label pos-label">Monnaie FCFA
                              </label>
                            </div>
                            <div class="col-md-7">
                          ...
                          <div class="row form-group">
                            <div class="col-md-5">
                              <label for="example-text-input" class=" col-form-label pos-label">Reste à Payé
                              </label>
                            </div>
                            <div class="col-md-7">
...
<!--                              <label for="example-text-input" id="sales" class="col-form-label" style="color:#007bff">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          <button type="submit" id="salesposSubmit" class="btn waves-effect waves-light btn-secondary" style="width: 70%;">IMPRIMER 
                          </button>
                        </div>
                      </div> 
                      </form>
                ...
                <?php
                    $customerList = $this->customer_model->getAllCustomer();
                 ?>
...
<!--<div class="modal fade" id="invoicemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    ...
    <footer class="footer"> © 2020 Wise Concept
    </footer>
