            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    <ul class="navbar-nav mr-auto mt-md-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu mailbox scale-up-left">
                                <ul>
                                    <li>
                                        <div class="drop-title">A Court de Stock</div>
                                    </li>
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <a href="<?php echo base_url();?>invantory/Stock_short">
                                                <div class="mail-contnet">
                                                    <h5><?php echo $value->product_name?> (<?php echo $value->strength?>): <span style="color: red!important;"><?php echo $value->instock;  ?></span></h5> <span class="mail-desc"><?php echo $value->generic_name?></span> <span class="time"><?php echo $value->expire_date ?></span> 
                                                    </div>
                                            </a>
                                            <?php endforeach; ?>
                                        </div>
                                    ...
                                    <li>
                                        <a class="nav-link text-center" href="<?php echo base_url();?>invantory/Stock_short"> <strong>Voir Plus</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu mailbox scale-up-left" aria-labelledby="2">
                                <ul>
                                    <li>
                                        <div class="drop-title">Médicament En Rupture</div>
                                    </li>
                                    <li>
                                        <div class="message-center">
                                           <?php foreach($stockout as $value): ?>
                                            <a href="<?php echo base_url();?>invantory/Stock_out">
                                                <div class="mail-contnet">
                                                    <h5><?php echo $value->product_name?>(<?php echo $value->strength?>): <span style="color: red!important;"><?php echo $value->instock;  ?></h5> <span class="mail-desc"><?php echo $value->generic_name?></span> <span class="time"><?php echo $value->expire_date;  ?></span> 
                                                    </div>
                                            </a>
                                            <?php endforeach; ?>
                                        </div>
                                    ...
                                    <li>
                                        <a class="nav-link text-center" href="<?php echo base_url();?>invantory/Stock_out"> <strong>Voir plus</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                      
                        <p style="color: white;margin-top: 1px;"><?php echo $settings->name ?></p>
                    ...
                    <ul class="navbar-nav my-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $user->em_name ?> <img src="<?php echo base_url(); ?>assets/images/users/<?php echo $user->em_image ?>" alt="" class="profile-pic"></a>
                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                           <?php 
                                            $userid =$this->session->userdata('user_login_id');                             $user = $this->user_model->GetEmployeeValueById($userid); ?>
                                            <div class="u-img"><img src="<?php echo base_url(); ?>assets/images/users/<?php echo $user->em_image ?>" alt="" class="profile-pic"></div>
                                            <div class="u-text">
