            ...
            <div class="container-fluid" style="padding-top: 30px;">
                <div class="row m-b-10"> 
                    <div class="col-7">
                        ...
                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a href="<?php echo base_url()?>invoice/Pos_Create" class="text-white"><i class="" aria-hidden="true"></i>Facture</a></button>
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">                                
                                <h4 class="m-b-0 text-white">Nouvelle Facture <span class="pull-right"> 
                               ...
                               <form action="Save" method="post" id="SalesForm" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="form-group" style="margin-bottom: 15px">
                                        <select class="select2 customerid" value="" name="customerid" style="width: 100%; height:36px;border-radius: 0px;">
                                            <option>Nom Du Client(Type)</option>
                                            <optgroup>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="select2 customerid" name="customerid" style="width: 100%; height:36px;border-radius: 0px;">
                                            <option >Identifiant Client (Type)</option>
                                                <?php foreach ($customer as $value) {?>
                                        ...
                                        <div class="form-group" style="margin-bottom: 15px">
                                            <input type="text" id="invoice" name="invoice" value="<?php echo rand(000001,1000000000); ?>" class="form-control" placeholder="" readonly>
                                        </div>                                        
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group" style="margin-bottom: 15px">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered m-t-10">
                                        <thead>
                                            <tr>
                                                <th width="15%">Nom Du Produit(Strength)<span class="text-danger">*</span> </th>
                                                <th width="15%">Nom Générique<span class="text-danger">*</span> </th>
                                                <th width="8%">Forme</th>
                                                <th width="6%">Stock</th>
                                                <th width="8%">Quantité<span class="text-danger"> *</span></th>
                                            ...
                                            <tr>
                                                <td>
                                                    <select class="select2 productid" style="width: 100%; height:36px;border-radius: 0px;" name="productid[]" required>
                                                        <option>Nom Du Produit(Strength)</option>
                                                        <optgroup>
                                        ...
                                        <tfood>
                                            <tr>
                                                <td colspan=6></td>
                                                <td class="text-right font-weight-bold">Total Déduit:</td>
...
<!--                                             <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right font-weight-bold"  colspan=6>Payé:</td>
...
<!--                                                    <button class="btn btn-primary pull-left">Full Paid </button> 
                                                ...
                                                <td class="text-right font-weight-bold" colspan=6>Reste à Payer:</td>
