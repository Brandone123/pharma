            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10"> 
                    ...
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a href="<?php echo base_url();?>Employee/Create" class="text-white"><i class="" aria-hidden="true"></i> Ajouter Un Employé</a></button>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-header">
                                ...
                                <h4 class="m-b-0 text-white">Gérer Les Employés </h4>
                                           ...
                                           <?php foreach($userList as $value): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                    ...
                                                    <a onclick="return confirm('Etês-vous sûre de vouloir Supprimer?')" href="<?php echo base_url();?>Employee/delete?id=<?php echo $value->em_id;?>" title="Delete" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
      ...
      <form action="Update" method="post" id="employeefORM" class="form-horizontal" enctype="multipart/form-data" accept-charset="utf-8">
            <div class="modal-body">
                                           <div class="row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <select class="form-control" name="emstatus">
                                                            ...
                                                            <option>Selection du statut</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">Image Client</label>
                                                    <div class="col-md-7">
