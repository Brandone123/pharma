                  ...
                  <div class="pos_inputs">
                      <div class="row m-b-5">
                        ...
                        <div class="col-md-3">
                          ...
                          <label for="Regular">Client Régulier</label>                            
                          ...
                          <label for="Wholesale">Client En Gros</label>                              
                            <?php } else {?> 
                          ...
                          <div class="table-responsive mb-15" style="height: 300px; overflow-y: auto; ">
                            <table class="table table-bordered m-t-5 purchase">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" name="genname[]" placeholder="idem" readonly="" value="<?php echo $value->generic_name ?>"></td>
                                            ...
                                            <td><input type="text" class="form-control total" name="total[]" placeholder="" value="0 FCFA" readonly></td>
                                        </tr>
                                        <?php endforeach; ?>
                                       </tbody>
                                        <tfoot id="salesReturn">
                                            <tr>
                                               <td rowspan="3" colspan="5"></td>
                                                ...
                                                <td><input type="text" class="form-control gtotal" name="grandamount" placeholder="" readonly="" value="0 FCFA"></td>
                                            </tr>
                                            <tr>
                                                <td class="text-right font-weight-bold" colspan="1">Total Deduction:</td>

                                                <td><input type="text" class="form-control granddeduction" name="granddeduction" readonly value="0 FCFA"></td>
                                            </tr>
                                            <tr>
                                                <td class="text-right font-weight-bold" colspan="1">Return Total:</td>
                                                <td><input type="text" class="form-control returntotal" name="returntotal" placeholder="" readonly="" value="0 FCFA"></td>
                                            </tr>
