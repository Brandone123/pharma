...
/*    public function Create(){
   ...
   public function Today_report(){
       ...
       $date = strtotime($today);
        ...
        $data['totaltodaysreport'] = $this->sales_model->GetTotalTodaySales($date);
   ...
   public function Purchase_Return_Invoice(){
    ...
    public function DeleteSaleReport(){
       ...
       $data['sales_return']=$this->Sales_model->DeleteSaleReportID($id); 
       echo "Successfully Deleted";
       redirect(base_url().'Sales_Return/sale','refresh');
    }
   ...
   public function Sales_Return_Form(){
        ...
        $this->load->library('form_validation');
            ...
            if($this->db->affected_rows()){               
                ...
                $success = $this->purchase_model->Update_Medicine($medicine,$data);
                    ...
                    $response['curl'] = base_url(). "Sales/Sales_Return";
    ...
    public function GetSalesInvoiceReport(){
       date_default_timezone_set("Africa/Douala");
        ...
        $createtime = date('h:i A',$invoice->sales_time);
...
echo " <div class='card-body pos_receipt' style='text-align:center;'>
                                <div class='receipt_header'>
                                  ...
                                  <p class='customer-details;margin-bottom:5px;'>
                                    ...
                                    <span style='float:right;right;font-size: 12px;font-weight: 600;color: #000'>Facture N°$invoiceno</span><br>
        ...
        foreach($invoice_details as $value):
            ...
            <td style='right;font-size: 12px;font-weight: 600;color: #000'>";echo $id; echo"</td>
              ...
              <td style='right;font-size: 12px;font-weight: 600;color: #000'>$value->qty</td>
              <td style='right;font-size: 12px;font-weight: 600;color: #000'>$value->mrp FCFA</td>
              <td style='right;font-size: 12px;font-weight: 600;color: #000'>$value->total_price FCFA</td>              
            </tr>";
          ...
          echo "</tbody></table>
                              ...
                              <table style='font-size:8px'>
                                <tr>
                                  ...
                                  <td colspan='1'></td>
                                  <td style='right;font-size: 12px;font-weight: 600;color: #000'>Payé: $invoice->paid_amount FCFA</td>
                                </tr>
                                <tr>
                                  <td colspan='1'></td>
                                  <td style='right;font-size: 12px;font-weight: 600;color: #000'>Reste à Payer: $invoice->due_amount FCFA</td>
                                </tr>
                              </table>
                            </div>
